...
public class NanoHTTPD {
  ...
  public Response serveFile(String uri, Properties header, File homeDir, boolean allowDirectoryListing) {
    ...
    if (res == null && f.isDirectory()) {
      ...
      if (!newUri.endsWith("/")) {
        newUri += "/";
        res = new Response(HTTP_REDIRECT, MIME_HTML, "<html><body>Redirected: <a href=\"" + newUri + "\">" + newUri
            + "</a></body></html>");
   ...
   */
  private static HashMap<String, String> theMimeTypes = new HashMap<String, String>();
  static {
    ...
    theMimeTypes.put("mp4", "video/mp4");
    theMimeTypes.put("ogv", "video/ogg");
    theMimeTypes.put("flv", "video/x-flv");
    theMimeTypes.put("mov", "video/quicktime");
    theMimeTypes.put("swf", "application/x-shockwave-flash");
    theMimeTypes.put("js", "application/javascript");
